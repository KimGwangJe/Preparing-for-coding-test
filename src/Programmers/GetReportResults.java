...
//        // 각 유저가 한 번 이상 신고한 대상을 기록하기 위한 Map
//        Map<String, Set<String>> userReports = new HashMap<>();
//        // 신고 횟수 누적
//        int[] num = new int[id_list.length];
//
//        // 각 유저가 한 번 이상 신고한 대상 기록
//        for (String r : report) {
//            String[] temp = r.split(" ");
//            String reporter = temp[0];
//            String reported = temp[1];
//
//            if (!userReports.containsKey(reporter)) {
//                userReports.put(reporter, new HashSet<>());
//            }
//            userReports.get(reporter).add(reported);
//        }
//
//        // 중복된 신고 처리
//        for (String reporter : userReports.keySet()) {
//            for (String reported : userReports.get(reporter)) {
//                num[Arrays.asList(id_list).indexOf(reported)]++;
//            }
//        }
//
//        // 메일 보내기
...
//            if (k <= num[i]) {
//                for (String reporter : userReports.keySet()) {
//                    if (userReports.get(reporter).contains(id_list[i])) {
...
//        GRR grr = new GRR();
//        System.out.println(grr.solution(new String[]{"muzi", "frodo", "apeach", "neo"},new String[]{"muzi frodo","apeach frodo","frodo neo","muzi neo","apeach muzi"},2));
//    }
//}
