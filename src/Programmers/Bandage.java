...
class Band {
    public int solution(int[] bandage, int health, int[][] attacks) {
        int answer = health;
        int second = 0; // 총 반복
        int idx = 0; // attacks[idx][0]번째
        int bandsec = 0; // 몇초동안 밴드를 사용했는지
...
public class Bandage {
    public static void main(String[] args){
        Band band = new Band();
        System.out.println(band.solution(new int[]{5,1,5},30,new int[][]{{2,10},{9,15},{10,5},{11,5}}));
    }
}
